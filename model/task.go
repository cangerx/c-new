...
// GetByTaskIdForAdmin looks up a task without applying an owner filter.
// Callers must enforce administrator authorization before using this helper.
...
// GetByTaskIds preserves the legacy bulk lookup used by older task clients.
